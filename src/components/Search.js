...
function Search() {
  ...
  const fetchTopHeadlines = () => {
    axios
      .get("https://newsapi.org/v2/top-headlines?country=us&apiKey=7328840c8ea54e409510c308b56270ac")
      .then((res) => {
  ...
  const handleSearch = (e) => {
    ...
    if (searchQuery) {
      axios
        .get(`https://newsapi.org/v2/everything?q=${searchQuery}&apiKey=7328840c8ea54e409510c308b56270ac`)
        .then((res) => {
          console.log(res.data);
          setNews(res.data.articles);
        })
